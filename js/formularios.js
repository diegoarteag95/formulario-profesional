...
formulario.addEventListener(`submit`, (e) => {
  ...
  if (campos.usuario && campos.nombre && campos.password && campos.correo && campos.telefono && terminos.checked) {
    ...
    document.getElementById(`formularios__mensaje`).classList.add(`formularios__mensaje-activo`);
    setTimeout(() => {
      document.getElementById(`formularios__mensaje`).classList.remove(`formularios__mensaje-activo`);
    }, 5000);
  }
});
